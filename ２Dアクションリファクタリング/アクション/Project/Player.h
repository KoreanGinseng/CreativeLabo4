...
private:
	...
	Sample::TransformPtr		m_Transform;
...
public:
	...
	Sample::Rectangle GetRect(){
		if(IsAttack())
		{
			return Sample::Rectangle(m_Transform->GetPositionX() + PLAYER_RECTDECREASE,m_Transform->GetPositionY() + PLAYER_RECTDECREASE,m_Transform->GetPositionX() + m_SrcRect.GetWidth() - PLAYER_RECTDECREASE - PLAYER_ATTACKWIDTH,m_Transform->GetPositionY() + m_SrcRect.GetHeight());
		}
		return Sample::Rectangle(m_Transform->GetPositionX() + PLAYER_RECTDECREASE,m_Transform->GetPositionY() + PLAYER_RECTDECREASE,m_Transform->GetPositionX() + m_SrcRect.GetWidth() - PLAYER_RECTDECREASE,m_Transform->GetPositionY() + m_SrcRect.GetHeight());
	}
	Sample::Rectangle GetAttackRect(){
		//反転中
		if(m_Move->IsReverse())
		{
			return Sample::Rectangle(m_Transform->GetPositionX() - PLAYER_ATTACKWIDTH,m_Transform->GetPositionY(),m_Transform->GetPositionX() + PLAYER_RECTDECREASE,m_Transform->GetPositionY() + m_SrcRect.GetHeight());
		}
		return Sample::Rectangle(m_Transform->GetPositionX() + m_SrcRect.GetWidth() - PLAYER_RECTDECREASE - PLAYER_ATTACKWIDTH,m_Transform->GetPositionY(),m_Transform->GetPositionX() + m_SrcRect.GetWidth(),m_Transform->GetPositionY() + m_SrcRect.GetHeight());
	}
