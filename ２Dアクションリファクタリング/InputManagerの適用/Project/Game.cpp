...
bool CGame::Load(void){
	//入力作成
	InputManagerInstance.AddKeyboardKey("Horizontal", MOFKEY_RIGHT, MOFKEY_LEFT);
	InputManagerInstance.AddKeyboardKey("Jump", MOFKEY_UP);
	InputManagerInstance.AddKeyboardKey("Attack", MOFKEY_SPACE);
