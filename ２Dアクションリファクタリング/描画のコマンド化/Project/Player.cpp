 ...
 * [in]			wy					ワールドの変化
 */
void CPlayer::Render(float wx, float wy, Sample::RenderCommandTaskPtr& task){
	...
	//テクスチャの描画
	task->Push(Sample::TextureRenderCommand::Create(px, py, dr, m_Texture), 1);
}
